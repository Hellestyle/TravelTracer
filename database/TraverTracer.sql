...
-- Schema stud_v23_she199
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `stud_v23_she199` DEFAULT CHARACTER SET utf8 ;
USE `stud_v23_she199` ;
...
CREATE TABLE IF NOT EXISTS `stud_v23_she199`.`user_system_meta` (
  ...
  `open_profile` TINYINT NOT NULL DEFAULT 1,
  `show_real_name` TINYINT NOT NULL DEFAULT 0,
  `show_friend_list` TINYINT NOT NULL DEFAULT 1,
...
-- -----------------------------------------------------
-- Table `stud_v23_she199`.`age_category_meta`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `stud_v23_she199`.`age_category_meta` ;

CREATE TABLE IF NOT EXISTS `stud_v23_she199`.`age_category_meta` (
  `age_category_id` INT UNSIGNED NOT NULL,
  `language_id` INT UNSIGNED NOT NULL,
  `name` VARCHAR(200) NOT NULL,
  PRIMARY KEY (`age_category_id`, `language_id`),
  INDEX `acm_language_id_fk_idx` (`language_id` ASC) VISIBLE,
  CONSTRAINT `acm_age_category_id_fk`
    FOREIGN KEY (`age_category_id`)
    REFERENCES `stud_v23_she199`.`age_category` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `acm_language_id_fk`
    FOREIGN KEY (`language_id`)
    REFERENCES `stud_v23_she199`.`language` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT)
